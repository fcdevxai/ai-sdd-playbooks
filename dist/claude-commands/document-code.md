# /document-code — Documentación técnica de código en Confluence
...
```
/document-code [ticket-slug]
```

## Cuándo ejecutar

Cuando necesitas documentar código del proyecto (entidad, servicio, controlador o componente frontend) en Confluence.
