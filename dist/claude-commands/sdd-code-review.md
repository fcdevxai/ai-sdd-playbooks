# /sdd-code-review — SDD Code Review - Spec Compliance Review
...
Despues de `/sdd-apply` y antes de `/sdd-ux-gate` (o `/sdd-commit` si no aplica UX), cuando `testing-report.md` esta generado.
