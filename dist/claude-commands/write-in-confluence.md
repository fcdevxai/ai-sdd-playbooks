# /write-in-confluence — Guía operacional en Confluence
...
```
/write-in-confluence [ticket-slug]
```

## Cuándo ejecutar

Cuando necesitas redactar una guía operacional sobre una funcionalidad de la plataforma y publicarla en Confluence para el equipo interno (Operaciones, Soporte).
