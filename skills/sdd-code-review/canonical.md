...
description: "Review implemented code against the proposal before opening a PR: validate spec coverage, scope compliance, and project conventions, then write code-review-report.md with a normalized passed/failed status. Activate when the user says 'sdd-code-review', 'review against spec', or 'pre-PR review'. Triggers: revisa contra la spec, validacion tecnica."
description_es: "Revisar el código implementado contra la proposal antes de abrir un PR: cobertura de la spec, cumplimiento de scope y convenciones del proyecto, generando code-review-report.md con un status normalizado."
title_en: "SDD Code Review — Pre-PR Technical Review"
