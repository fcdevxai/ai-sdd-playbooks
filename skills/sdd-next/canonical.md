...
description_es: "Preguntarle al CLI de SDD cuál es el próximo paso válido para el change actual y actuar en consecuencia."
title_en: "SDD Next — Ask the CLI What's Next"
title_es: "SDD Next — Preguntar el Próximo Paso"
when: "Any time the user asks what to do next, or between skill invocations."
output_file: "N/A — read-only"
