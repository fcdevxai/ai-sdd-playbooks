/**
 * `playbook install` — install/refresh core skills into the global agent dirs.
 *
...
export async function installCommand(parsed, io) {
  ...
  // Add-ons are opt-in: via --addon and/or `addons:` in the project's playbook.config.yaml.
