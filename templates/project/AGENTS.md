...
> Cross-agent context shared by Claude Code, GitHub Copilot, and Codex. Keep this
> the single source of project truth; `CLAUDE.md` and
> `.github/copilot-instructions.md` reference it.
